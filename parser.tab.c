...
{
       0,    84,    84,    85,    89,    90,    94,    98,   104,   113,
     131,   137,   143,   150
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "PLUS", "';'", "','", "$accept", "program", "statement",
  "declaration", "id_list", "assignment", "expression", "term", YY_NULLPTR
};
...
{
       0,    11,     0,     3,     5,    12,    13,    15,     6,     3,
      14,     3,     4,    16,    17,     8,     9,     7,     8,     3,
      17
};
...
#line 113 "parser.y"
        ...
        node *idNode = createNode((yyvsp[-3].str));
        node *assignNode = createNode("=");

        assignNode->left = idNode;
        assignNode->right = (yyvsp[-1].nd);
...
#line 131 "parser.y"
            ...
            plusNode->left = (yyvsp[-2].nd);
            plusNode->right = (yyvsp[0].nd);
            (yyval.nd) = plusNode;
      }
...
#line 143 "parser.y"
         {
            ...
            (yyval.nd) = createNode((yyvsp[0].str));
      }
